...
# Main command class
class linux_proc_info(linux_pslist.linux_pslist):
#class linux_proc_info(linux_common.AbstractLinuxCommand):  
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        #self.get_threads = linux_threads.linux_threads(config).calculate
    ...
    #                 outfd.write("Map looked like stack\n")
            ...
            #self.render_annotated_list(stack)
...
class process_info(object):
    ...
    def get_map_by_name(self, name, permissions='r-x'):
        ...
        for vma in self.task.get_proc_maps():
            ...
            print "plugins/linux --- linux_proc_info --- get_map_by_name libname:",libname
