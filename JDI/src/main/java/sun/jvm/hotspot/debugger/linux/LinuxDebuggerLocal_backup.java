...
public class LinuxDebuggerLocal_backup extends DebuggerBase implements LinuxDebugger {
    ...
    interface WorkerThreadTask {
       public void doit(LinuxDebuggerLocal_backup debugger) throws DebuggerException;
    }

    class LinuxDebuggerLocalWorkerThread extends Thread {
       LinuxDebuggerLocal_backup debugger;
       WorkerThreadTask task;
       DebuggerException lastException;

       public LinuxDebuggerLocalWorkerThread(LinuxDebuggerLocal_backup debugger) {
    ...
    public LinuxDebuggerLocal_backup(MachineDescription machDesc,
    ...
    private void findABIVersion() throws DebuggerException {Frames.lookupByNameCount.add();
    ...
    public synchronized void attach(int processID) throws DebuggerException {
        ...
        class AttachTask implements WorkerThreadTask {
           int pid;
           public void doit(LinuxDebuggerLocal_backup debugger) {
              debugger.attach0(pid);Frames.attachCount.add();
    ...
    public synchronized boolean detach() {
        ...
        if (isCore) {
            ...
            class DetachTask implements WorkerThreadTask {
                ...
                public void doit(LinuxDebuggerLocal_backup debugger) {
                    debugger.detach0();Frames.detachCount.add();
    ...
    public synchronized Address lookup(String objectName, String symbol) {
        ...
        if (isCore) {
            ...
            class LookupByNameTask implements WorkerThreadTask {
                ...
                public void doit(LinuxDebuggerLocal_backup debugger) {
                    long addr = debugger.lookupByName0(objectName, symbol);Frames.lookupByNameCount.add();
    ...
    public synchronized long[] getThreadIntegerRegisterSet(int lwp_id)
        ...
        if (isCore) {
            ...
            class GetThreadIntegerRegisterSetTask implements WorkerThreadTask {
                ...
                long[] result;
                public void doit(LinuxDebuggerLocal_backup debugger) {
                    result = debugger.getThreadIntegerRegisterSet0(lwp_id);Frames.getThreadIntegerRegisterSetCount.add();
                }
            }
    ...
    public synchronized ClosestSymbol lookup(long addr) {
       ...
       if (isCore) {
          ...
          class LookupByAddressTask implements WorkerThreadTask {
             ...
             public void doit(LinuxDebuggerLocal_backup debugger) {
                 result = debugger.lookupByAddress0(addr);Frames.lookupByAddressCount.add();
             }
          }
    ...
    public synchronized ReadResult readBytesFromProcess(long address,
        ...
        if (isCore) {
            ...
            class ReadBytesFromProcessTask implements WorkerThreadTask {
                ...
                ReadResult result;
                public void doit(LinuxDebuggerLocal_backup debugger) {
                    byte[] res = debugger.readBytesFromProcess0(address, numBytes);Frames.readBytesFromProcessCount.add();
                    if (res != null)
